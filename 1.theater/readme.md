...
#### [ポリモフィズムによる条件記述の置き換え](https://github.com/jinyongnan810/refactoring/commit/d4369fd083d18994a385b949f96f645dfe1ebf1f)
...
- 細かくリファクタリングすること
- 関数外に共通関数を抽出の思考方式と別に、関数内部で、JS の Closure を利用し、関数内部の関数抽出でコードの流れを明確にすること
- フェーズを分割し、次のフェーズ用のデータ構造を作成すること
- クラスを利用し、関数の呼び出しを暗黙化する
